 ...
 *
 * List class defines a recursive type called List, and provides constructor
 * and getter methods.
 */
...
public class List {
 ...
 if this list is empty
	...
	/**
	 * returns the head of this list or throws an exception if the list is
	 * empty
	...
	/**
	 * returns the tail of this list or throws an exception if the list is
	 * empty
	 * @throws IllegalStateException if the list is empty
	 */
	public List getTail() {
