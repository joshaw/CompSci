...
\lstinputlisting[frame=single, language=SQL, firstline=12]{astro.sql}

% section table_creation (end)

\section{Adding Entities}
\label{sec:adding_entities}

\lstinputlisting[frame=single, language=SQL, firstline=7]{astroInsert.sql}

% section adding_entities (end)

\section{Queries}
\label{sec:queries}

\lstinputlisting[frame=single, language=SQL]{astroQuery.sql}
